...
conjoint_data <- read_excel("Adv Stats Prefs Updated.xlsx")
...
perform_conjoint_analysis <- function(preference_ranks){
  ...
  cost_estimates <- c("Intercept" = 1000, "Screen 75 inch" = 500, "Screen 85 inch" = 1000, "Resolution 4k" = 250, "Sony Brand" = 250)
  ...
  # Own Brand Design
  my_design <- c("Intercept" = 1, "Screen 75 inch" = 0, "Screen 85 inch" = 1, "Resolution 4k" = 0, "Sony Brand" = 0, "Price" = 1500)
